class Milestone < ApplicationRecord
  ...
  # a hidden milestone is left off the timeline and out of the find overlay, and the stretch it covered is accounted for like any other gap
  ...
  def self.chronological_with_gaps
    ascending = visible.chronological.reverse
