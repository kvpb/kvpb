...
class MilestoneTest < ActiveSupport::TestCase
  ...
  test "visible leaves out a hidden milestone, and so does the timeline" do
    shown = Milestone.create!( title: "Shown", organization: "Org", starts_on: 2.years.ago )
    hidden = Milestone.create!( title: "Hidden", organization: "Org", starts_on: 1.year.ago, hidden: true )

    assert_includes Milestone.visible, shown
    assert_not_includes Milestone.visible, hidden
    assert_not_includes Milestone.chronological_with_gaps, hidden
  end
