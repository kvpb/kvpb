...
class AlbumsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "a photograph shown alone and a Cover Flow's central cover keep square corners, while its side and rear photographs are squircled" do
  ...
  test "an album's own page sets every one of its photographs with square corners, while all four of a Cover Flow's side and rear photographs are squircled and its central cover is not" do
    ...
    assert_select ".album_cover_flow img.cover_flow_side[data-controller~='squircle-clip']", count: 2
    assert_select ".album_cover_flow img.cover_flow_hint[data-controller~='squircle-clip']", count: 2
    assert_select ".album_cover_flow img.cover_flow_cover[data-controller~='squircle-clip']", count: 0
