...
class SettingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "update shows and hides the menu entries" do
    ...
    patch settings_path, params: { setting: { twitter_visible: "1", github_visible: "0" } }
  ...
  test "the menu hides Twitter\\X by default and keeps its markup out of the page, but shows GitHub" do
    get root_path
  ...
  test "the menu shows Twitter\\X once it is turned on, and hides GitHub once it is turned off" do
    Setting.current.update!( twitter_visible: true, github_visible: false )
