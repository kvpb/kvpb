...
class ArticlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "index still renders for a signed-in admin when the journal is empty" do
    Article.published.destroy_all
    sign_in_as( users( :one ) )
  ...
  test "show renders a draft for a signed-in admin" do
    sign_in_as( users( :one ) )
  ...
  test "update lets an admin publish and lock comments" do
    sign_in_as( users( :one ) )
