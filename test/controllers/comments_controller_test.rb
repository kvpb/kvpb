...
class CommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "approve requires a signed-in admin" do
  ...
  test "admin can approve a pending comment" do
  ...
  test "admin rejecting a comment deletes it and emails the author a copy" do
    sign_in_as( users( :one ) )
    comment = comments( :pending_guest )
    article = comment.article
